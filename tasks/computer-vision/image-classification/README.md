...
You can read more details about the project in this Medium [blog](https://medium.com/@mohamedalihabib7/brain-tumor-detection-using-convolutional-neural-networks-30ccef6612b0).
...
The best validation accuracy was achieved on the 24th iteration.
...
2. The weights for all the models. The best model is named as 'cnn-parameters-improvement-24-0.90.model'.
...
4. The original data in the folders named 'yes' and 'no'. And, the augmented data in the folder named 'augmented data'.<br>
